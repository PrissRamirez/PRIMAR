...
class Customer extends CActiveRecord
{
	...
	{
		return array(
			array('name, email, address, zipcode, city, country', 'required'),
			array('customer_id, name', 'numerical', 'integerOnly'=>true),
			array('address, zipcode, city, country, email', 'length', 'max'=>45),
			array('email', 'CEmailValidator'),
			array('customer_id, name, address, zipcode, city, country, email', 'safe', 'on'=>'search'),
		);
	}
